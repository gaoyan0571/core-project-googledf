...
/**
 * 继承自 java.util.HashMap 的类，完成对象的转换和快速存取的功能
 * 
 * @author	谢锦楠
 */
...
public class MapRecord extends HashMap<String, Object> {
	...
	public String toString() {
		...
		stringBuffer.append("MapRecord = ").append("{");
	...
	public static MapRecord toRecord(Object vo) throws Exception {
		...
		for (int i = 0; i < fields.length; i++) {
			...
			record.set(fields[i].getName(), fields[i].get(vo));
		}
	 ...
	 * @param vo	数据转换的目标对象
	 * @return 数据转换后的 VO 对象
	 * @throws IllegalAccessException	Field 对象的存取性为 false 时，对其操作会产生 IllegalAccessException
	 * @throws NullPointerException	当传入的 vo 对象为空时，抛出 NullPointerException
	 */
	public static Object toVo(MapRecord record, Object vo) throws IllegalAccessException, NullPointerException {
